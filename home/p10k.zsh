# Generated by Powerlevel10k configuration wizard on 2021-06-26 at 18:59 +07.
...
# 24h time, 2 lines, dotted, no frame, white-ornaments, compact, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern|flux'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|sops'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gcs|sops|kubectl'
  # Google cloud color.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION}:${P9K_GCLOUD_ACCOUNT//\%/%%}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION}:${P9K_GCLOUD_ACCOUNT//\%/%%}'
