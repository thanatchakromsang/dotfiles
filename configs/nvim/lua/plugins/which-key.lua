...
wk.add(
  {
    ...
    { "<leader>op", function() require('opencode').select() end, desc = "prompt select", nowait = false, remap = false },
    { "<leader>oC", function() require('opencode').command('agent.cycle') end, desc = "cycle agent", nowait = false, remap = false },
    { "<leader>oc", function() require('opencode').command('prompt.clear') end, desc = "clear promt", nowait = false, remap = false },
    { "<leader>oS", function() require('opencode').command('prompt.submit') end, desc = "submit prompt", nowait = false, remap = false },
    ...
    { "<leader>os", group = "session", nowait = false, remap = false },
    { "<leader>osi", function() require('opencode').command('session.interrupt') end, desc = "interrupt", nowait = false, remap = false },
    { "<leader>osl", function() require('opencode').command('session.list') end, desc = "list", nowait = false, remap = false },
    { "<leader>osf", function() require('opencode').command('session.first') end, desc = "first", nowait = false, remap = false },
    { "<leader>osL", function() require('opencode').command('session.last') end, desc = "last", nowait = false, remap = false },
    { "<leader>osu", function() require('opencode').command('session.undo') end, desc = "undo", nowait = false, remap = false },
    { "<leader>osr", function() require('opencode').command('session.redo') end, desc = "redo", nowait = false, remap = false },
    { "<leader>osU", function() require('opencode').command('session.half.page.up') end, desc = "half page up", nowait = false, remap = false },
    { "<leader>osD", function() require('opencode').command('session.half.page.down') end, desc = "half page down", nowait = false, remap = false },
    { "<leader>osc", function() require('opencode').command('session.compact') end, desc = "compact", nowait = false, remap = false },
    { "<leader>osn", function() require('opencode').command('session.new') end, desc = "new", nowait = false, remap = false },
