...
[COLEMAK_LAYER] = LAYOUT_ergodox_ez_wrapper(
  _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,  _______,  _______,  _______,  _______,
...
[GAME_LAYER] = LAYOUT_ergodox_ez_wrapper(
  _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,  _______,  _______,  _______,  _______,
  _______,  __________________GAME_L1__________________,        RESET,               RESET,      __________________GAME_R1__________________,  _______,
  _______,  __________________GAME_L2__________________,                                         __________________GAME_R2__________________,  _______,
  _______,  __________________GAME_L3__________________,      _______,             _______,      __________________GAME_R3__________________,  _______,
  _______,  _______,  _______,  _______,  GAME_L1,                                                     GAME_R1,  _______,  _______,  _______,  _______,

                                                     _______, _______,             _______, _______,
                                                              _______,             _______,
                                            ____GAME_L2_____, _______,             _______, ____GAME_R2_____
),
