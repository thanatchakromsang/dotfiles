...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [COLEMAK_LAYER] = LAYOUT_keyboardio_atreus_wrapper(
  ...
  [GAME_LAYER] = LAYOUT_keyboardio_atreus_wrapper(
    ...
    __________________GAME_L3__________________, _______,  _______, __________________GAME_R3__________________,
    _______, _______, _______, ________GAME_L4__________,  ________GAME_R4__________, _______, _______, _______
  ),
