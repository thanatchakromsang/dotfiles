...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LOWER] = LAYOUT_keyboardio_atreus_wrapper(
    ...
    QK_BOOT  , _______, _______, _________LOWER_L4________,  _________LOWER_R4________, _______, _______, _______
  ),
  ...
  [RAISE] = LAYOUT_keyboardio_atreus_wrapper(
    ...
    QK_BOOT  , _______, _______, _________RAISE_L4________,  _________RAISE_R4________, _______, _______, _______
  ),
  ...
  [MOUSE] = LAYOUT_keyboardio_atreus_wrapper(
    ...
    QK_BOOT  , _______, _______, _______MOUSE_L4__________,  _______MOUSE_R4__________, _______, _______, _______
  ),
};
