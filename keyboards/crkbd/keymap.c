...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [QWERTY] = LAYOUT_crkbd_wrapper(
    _______, _________________QWERTY_L1_________________,  _________________QWERTY_R1_________________, TO(GAMER),
  ...
  [GAMER] = LAYOUT_crkbd_wrapper(
    KC_LALT, __________________GAMER_L1_________________,  __________________GAMER_R1_________________, TO(QWERTY),
    KC_LCTL, __________________GAMER_L2_________________,  __________________GAMER_R2_________________, _______,
    KC_LSFT, __________________GAMER_L3_________________,  __________________GAMER_R3_________________, _______,
                               _______GAMER_L4__________,  _______GAMER_R4__________
  ),
  ...
  [LOWER] = LAYOUT_crkbd_wrapper(
    ...
    QK_BOOT  , __________________LOWER_L3_________________,  __________________LOWER_R3_________________, _______,
  ...
  [RAISE] = LAYOUT_crkbd_wrapper(
    ...
    QK_BOOT  , __________________RAISE_L3_________________,  __________________RAISE_R3_________________, _______,
  ...
  [ADJUST] = LAYOUT_crkbd_wrapper(
    ...
    QK_BOOT  , __________________ADJUST_L3________________,  __________________ADJUST_R3________________, _______,
  ...
  [MOUSE] = LAYOUT_crkbd_wrapper(
    ...
    QK_BOOT  , _________________MOUSE_L3__________________,  _________________MOUSE_R3__________________, _______,
