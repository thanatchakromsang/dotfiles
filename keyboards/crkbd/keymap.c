...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [QWERTY_LAYER] = LAYOUT_crkbd_wrapper(
    _______, _________________QWERTY_L1_________________,  _________________QWERTY_R1_________________, KC_F20,
    _______, _________________QWERTY_L2_________________,  _________________QWERTY_R2_________________, KC_MUTE,
  ...
  [COLEMAK_LAYER] = LAYOUT_crkbd_wrapper(
    _______, _________________COLEMAK_L1________________,  _________________COLEMAK_R1________________, KC_F20,
    _______, _________________COLEMAK_L2________________,  _________________COLEMAK_R2________________, KC_MUTE,
  ...
  [GAME_LAYER] = LAYOUT_crkbd_wrapper(
    ...
    RESET  , __________________GAME_L3__________________,  __________________GAME_R3__________________, _______,
                               ________GAME_L4__________,  ________GAME_R4__________
  ),
